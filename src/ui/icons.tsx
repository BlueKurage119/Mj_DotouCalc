// Material Icons (Apache-2.0) をインラインSVGコンポーネント化。絵文字は使用しない。
import type { SVGProps } from 'react'

function Icon(props: SVGProps<SVGSVGElement> & { d: string }) {
  const { d, ...rest } = props
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" {...rest}>
      <path d={d} />
    </svg>
  )
}
...
export function IconBackspace(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon
      {...props}
...
export function IconReturn(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props} d="M19 7v4H5.83l3.58-3.59L8 6l-6 6 6 6 1.41-1.41L5.83 13H21V7h-2z" />
}
